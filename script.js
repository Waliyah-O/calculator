...
// if the last array itm was not an operator, add the putput.value and the value of the button we clicked into the equaton array
...
// call above fucntion before adding active class to any btn
